...
namespace Wycieczki.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReservationId,StudentId,TripId,DateOfReservation")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReservationId,StudentId,TripId,DateOfReservation")] Reservation reservation)
        {
